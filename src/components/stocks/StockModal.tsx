...
export default function StockModal({ data, closeModal, visible, submit,udpating }: StockModalType) {
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col gap-3">
                                ...
                                <div className="w-full">
                                    ...
                                    <InputNumber
                                        ...
                                        onValueChange={(e) => handleNumberChange('price', e.value || 0)}
                                        className="w-full p-2 border rounded"
                                    />
                                    {errors.price && <small className="p-error">{errors.price}</small>}
                                </div>
                                <div className="w-full">
                                    <label htmlFor="supplier" className="block text-gray-700 font-bold mb-2">
                                        Supplier
                                    </label>
                                    <InputText
                                        id="supplier"
                                        ...
                                        className="w-full p-2 border rounded"
                                    />
                                    {errors.supplier && <small className="p-error">{errors.supplier}</small>}
                                </div>
                            </div>
                        </div>
                        <Button 
