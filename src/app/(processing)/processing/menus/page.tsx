        ...
        <div className="w-[40vw] flex-shrink-0 h-full p-3 gap-3 flex flex-col border-r border-neutral-60/30">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="w-full flex flex-col gap-2">
              ...
              <InputText
                ...
                onChange={(e) =>
                  vm.setMenuForm({ ...vm.menuForm, name: e.target.value })
                }
              />
            </div>
            <div className="w-full flex flex-col gap-2">
              ...
              <InputNumber
                ...
                onChange={(e) =>
                  vm.setMenuForm({ ...vm.menuForm, price: e.value! })
                }
                currency="IDR"
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="w-full flex flex-col gap-2">
              ...
              <Dropdown
                ...
                onChange={(e: DropdownChangeEvent) => [
                  vmCategory.setSelectedCategory(e.value),
                  vm.setMenuForm({ ...vm.menuForm, category: e.value }),
                ]}
                options={vmCategory.data?.data}
                optionLabel="name"
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <InputSwitch
                className="mt-3"
                checked={vm.menuForm.availability}
                onChange={(e) =>
                  vm.setMenuForm({ ...vm.menuForm, availability: e.value })
                }
              />
            </div>
          </div>
          ...
          <div className="w-full flex flex-row justify-end gap-2">
            <Button
              ...
              onClick={() =>
                vm.updating ? vm.handleUpdate() : vm.handleSendData()
              }
            />
            <Button
              label={"Clear Form"}
