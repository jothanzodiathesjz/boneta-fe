    ...
    return (
      <React.Fragment>
        <div className="flex flex-row ">
          <Button
            icon="pi pi-trash"
            onClick={() => vm_category.confirm2(rowData)}
            rounded
            outlined
            severity="danger"
          />
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <div className="w-full flex flex-row gap-4">
              <InputText
                ...
                onChange={(e) => (
                  vm_category.setMeja(e.target.value),
                  vm_category.setShowQr(false)
                )}
              />
              <Button
                label="Generate"
      ...
      >
        <div className="w-full flex flex-col gap-3">
          ...
          <TextInput
            ...
            onChange={(e) =>
              vm_category.setCategoryForm({
                ...vm_category.categoryForm,
                name: e.target.value,
              })
            }
          />
