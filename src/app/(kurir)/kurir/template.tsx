...
import KurirHeader from "@/layouts/Kurir.header";
...
export default function Template({ children }: { children: React.ReactNode}) {
  ...
  return (
    <div className='w-full flex flex-col md:w-[500px] justify-center overflow-x-hidden bg-[#FAFAFD]  rounded-sm layout-border'>
      <KurirHeader/>
    <AnimatePresence
    mode='sync'
    >
         
        {animationStore.isOpen && <motion.div 
        key={pathName}
        initial="hidden"
        animate="visible"
        exit="exit"
